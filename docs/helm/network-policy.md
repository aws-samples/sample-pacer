...
[ADR-0006](../../planning/adr/0006-strip-and-resign-auth.md) re-signs every request with
...
([`threat-model.md`](../../threat-model.md) T-008), so this is worth narrowing to the
...
are unauthenticated ([`threat-model.md`](../../threat-model.md) T-002/T-003) — so widening
...
* [`threat-model.md`](../../threat-model.md) — M-001, T-002, T-003, T-008.
* [ADR-0006](../../planning/adr/0006-strip-and-resign-auth.md).
