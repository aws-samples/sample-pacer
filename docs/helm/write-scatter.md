...
* [ADR-0032: A write populates the cache, and each chunk's home uploads its own part](../../planning/adr/0032-write-scatter-populates-the-cache.md)
* [planning/24-write-path.md](../../planning/24-write-path.md)
